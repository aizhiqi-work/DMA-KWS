...
class Wrapper(LightningModule):
    ...
    def configure_optimizers(self):
        ...
        scheduler = get_cosine_schedule_with_warmup(
            ...
            num_training_steps=100000  # 总训练步骤
        )
        return {
            "optimizer": optimizer,
            "lr_scheduler": {
...
if __name__ == "__main__":
    ...
    model_checkpoint = ModelCheckpoint(
        dirpath="/nvme01/openkws/qbyt_1460/ckpts/ft-ls-gs-1460->ls-gs-1460-100:1-ft",
    ...
    # TensorBoard日志
    logger = pl.loggers.TensorBoardLogger('/nvme01/openkws/qbyt_1460/logs', name='ft-ls-gs-1460->ls-gs-1460-100:1-ft')

    # 包装器
    wrapper = Wrapper.load_from_checkpoint("/nvme01/openkws/qbyt_1460/ckpts/ft-ls-gs-1460->ls-gs-1460/step_step=064000_auc_val_auc=0.975285.ckpt")
