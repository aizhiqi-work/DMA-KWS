...
if __name__ == "__main__":
    ...
    model_checkpoint = ModelCheckpoint(
        dirpath="/nvme01/openkws/qbyt_1460/ckpts/ft-ls-gs-1460->ls-gs-1460",
    ...
    # TensorBoard日志
    logger = pl.loggers.TensorBoardLogger('/nvme01/openkws/qbyt_1460/logs', name='ft-ls-gs-1460->ls-gs-1460')
