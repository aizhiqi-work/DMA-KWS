...
if __name__ == "__main__":
    ...
    train_dataset = LibriPhrasetTRAIN(
        parquet_file="/nvme01/openkws/libriphrase/counts/ls-460/aggregated_segments_with_g2p_distance.parquet",
        negative_ratio=1,
    ...
    model_checkpoint = ModelCheckpoint(
        dirpath="/nvme01/openkws/qbyt_460/ckpts/init-ls-460",
    ...
    # TensorBoard日志
    logger = pl.loggers.TensorBoardLogger('/nvme01/openkws/qbyt_460/logs', name='init-ls-460')
